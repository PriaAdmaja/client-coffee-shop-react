...
class MemberBanner extends Component {
    render() {
        return (
            <div className="flex flex-col sm:flex-row justify-center md:justify-between text-center w-[90%] md:w-4/5 2xl:w-[1120px] gap-7 items-center  ml-auto mr-auto rounded-xl relative -top-12 md:-top-[70px] xl:-top-24 bg-white py-6 md:py-10 xl:py-14 px-10 md:px-[60px] xl:px-[71px] shadow-xl -mb-20">
