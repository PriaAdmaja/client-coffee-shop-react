    ...
    render() {
        return (
            <section className="font-rubik bg-bgSecondary">
                <MemberBanner />
                <section className="flex pt-0 px-[30px] md:px-14 xl:px-[150px] pb-[10px] md:pb-10 xl:pb-[90px] 2xl:w-[1440px] 2xl:ml=auto 2xl:mr-auto text-sm md:text-base flex-col-reverse sm:flex-row gap-8">
