...
const AuthNav = (props) => {
    return (
        <nav className="flex items-center text select-none px-[5%] sm:px=[30px] xl:px-14 py-3 sm:py-5 lg:py-7 xl:py-14 justify-between bg-white sm:bg-none font-rubik ">
            <Logo />
