            ...
            <main className="font-rubik">
                <section className="bg-bgHero bg-cover bg-center bg-fixed text-white p-[5%]">
                    <section className="md:py-10">
                        ...
                        <p className="text-base md:text-xl mb-5">We provide high quality beans, good taste, and healthy meals made by love just for you. Start your
                            day with us for a bigger smile!</p>
                        <button className="bg-primary text-secondary w-1/2 md:w-2/6 h-[60px] border-none rounded-[10px] text-base font-bold ">Get Started</button>
                    </section>
                    <section className="flex flex-col md:flex-row justify-around items-center relative h-[400px] md:h-[200px] -bottom-[70px] p-9 shadow-2xl bg-white rounded-[10px] w-full ">
                        <section className="flex items-center justify-center gap-9">
                            ...
                            <section >
                                <h4 className="text-txtSecondary text-xl font-extrabold">90+</h4>
                                <p className="text-txtPrimary text-base">Staff</p>
                            </section>
                        </section>
                        ...
                        <section className="flex items-center justify-center gap-9">
                            ...
                            <section >
                                <h4 className="text-txtSecondary text-xl font-extrabold">30+</h4>
                                <p className="text-txtPrimary text-base">Stores</p>
                            </section>
                        </section>
                        <div className="w-full md:w-[2px] h-[2px] md:h-full bg-[#EEEFF2]"></div>
                        <section className="flex items-center justify-center gap-9">
                            ...
                            <section >
                                <h4 className="text-txtSecondary text-xl font-extrabold">800+</h4>
                                <p className="text-txtPrimary text-base">Customers</p>
                            </section>
                        </section>
                    </section>
                </section>
                <section className="pt-20 pb-[5%]">
                    <img className="w-full" src={teamWork} alt="team work" />
                    <section className="px-[5%] font-rubik flex gap-5 flex-col">
                ...
                <section className="p-[5%] bg-[#f0f0f0]">
                    ...
                    <section className="overflow-scroll">
                        <section className="pt-20 inline-flex gap-4">
                            <section className="w-[280px] h-[450px] md:h-[567px] relative bg-white border-2 border-solid border-[#DDDDDD] rounded-[10px] mx-auto pt-[90px] px-[5%] pb-12 ">
                                <section className="w-36 h-36 rounded-full overflow-hidden absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 shadow-2xl">
                                    <img src={hazelnutLatte} alt="hazelnut latte" className=" " />
                                </section>
                            ...
                            <section className="w-[280px] h-[450px] relative bg-white border-2 border-solid border-[#DDDDDD] rounded-[10px] mx-auto pt-[90px] px-[5%] pb-12">
                                <section className="w-36 h-36 rounded-full overflow-hidden absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 shadow-2xl">
                ...
                <section className="p-[5%] bg-[#f7f7f7]">
                    ...
                    <div className="grayscale flex flex-wrap justify-center gap-3 items-center">
